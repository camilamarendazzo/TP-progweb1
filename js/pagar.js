...
const TITULO = (document.querySelector(".plan-elegido").innerHTML =
  "Ha elegido el PLAN " + NOMBRE_PLAN);

if (NOMBRE_PLAN == "MENSUAL") {
  document.querySelector(".img").innerHTML =
    '<img src="../../assets/img/PlanMensual.jpg">';
  document.querySelector(".precio").innerHTML = "Total: $900";
} else if (NOMBRE_PLAN == "ANUAL") {
  document.querySelector(".img").innerHTML =
    '<img src="../../assets/img/PlanAnual.jpg">';
  document.querySelector(".precio").innerHTML = "Total: $9000";
} else if (NOMBRE_PLAN == "INFINITO") {
  document.querySelector(".img").innerHTML =
    '<img src="../../assets/img/PlanInfinito.jpg">';
